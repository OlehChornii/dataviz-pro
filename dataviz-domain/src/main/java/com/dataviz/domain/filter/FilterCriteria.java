...
public final class FilterCriteria {
    ...
    public static FilterCriteria categoricalIn(String column, Collection<?> allowed) {
    ...
    public Collection<?> getAllowedValues() { return allowedValues; }
    ...
    public static final class Builder {
        ...
        public Builder allowedValues(Collection<?> v) {
